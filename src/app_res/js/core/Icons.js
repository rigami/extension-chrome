...
export const Settings = props => new Icon({
...
export const ArrowDown = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const ArrowRight = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Check = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Refresh = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const PhotoLibrary = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Toll = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Widgets = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Info = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
...
export const Category = props => new Icon({
	props: { ...props, viewBox: "0 0 24 24" },
	icon: 
	`
