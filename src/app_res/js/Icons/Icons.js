...
export class ArrowBack extends Icon{
	constructor(props){
		super({
			props: {
				...props,
	...
	static create(){
		return new ArrowBack(...arguments);
	}
}
...
export class Widgets extends Icon{
	constructor(props){
		super({
			props: {
				...props,
...
export class Category extends Icon{
	constructor(props){
		super({
			props: {
				...props,
