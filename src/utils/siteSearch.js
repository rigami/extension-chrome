...
const getImageRecalc = (imageName, signal) => xhrPromise(`${appVariables.rest.url}/icon_parse/recalc/${imageName}`, { signal });

const getSiteInfo = (url, signal) => xhrPromise(`${appVariables.rest.url}/site_parse/get_data?url=${url}`, { signal });
